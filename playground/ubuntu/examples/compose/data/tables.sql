...
CREATE TABLE `node_tree_names` (
  ...
  PRIMARY KEY (`id`),
  KEY `node_tree_node_tree_names_fk` (`idNode`),
  CONSTRAINT `node_tree_node_tree_names_fk` FOREIGN KEY (`idNode`) REFERENCES `node_tree` (`idNode`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Dump completed on 2021-06-13  7:47:50
